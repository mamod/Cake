...
__PACKAGE__->Accessor('path','protocol');
...
sub new {
    ...
    return bless ( parseUri($url) , __PACKAGE__);
}
...
##based on javascript parseUri regular expression library by Steven Levithan
my $options = {
...
###javascript exec function emulator
sub _exec {
